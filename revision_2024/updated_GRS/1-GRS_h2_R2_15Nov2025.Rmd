...
risk_scores <- read.delim("~/PD_GRS/WC_scripts/prs_analyses/pd_prs_file_SS.txt", header=FALSE, sep=" ")
head(risk_scores) #90 Nalls SNPs and their weights
#           V1 V2      V3
...
terre_prs <- fread("~/PD_GRS/WC_scripts/prs_analyses/terre_prs_SS.sscore")
# GRS computed in TERRE based on 83/90 SNPs present after QC filtering
...
mean(meta$SCORE1_AVG) #0.001218328
sd(meta$SCORE1_AVG) #0.00301662
plot(density(meta$SCORE1_AVG))

meta$GRS_scaled <- scale(meta$SCORE1_AVG)
mean(meta$GRS_scaled) #1.783092e-17
sd(meta$GRS_scaled) #1

#mean and SD by PD status
meta_PD <- meta[meta$PD==1,]
mean(meta_PD$GRS_scaled) #0.2716028
sd(meta_PD$GRS_scaled) #1.053262

meta_ctrl <- meta[meta$PD==0,]
mean(meta_ctrl$GRS_scaled) #-0.130296
sd(meta_ctrl$GRS_scaled) #0.9497389
...
write.csv(meta, file="~/PD_GRS/meta_geno_DNAm_PCs_15Nov2025.csv", row.names=F) 
```
![GRS distribution before and after scaling](/home1/NEURO/schaffner/PD_GRS/grs_scaled_15Nov2025.png)

![GRS distribution before and after scaling, on the same x-axis](/home1/NEURO/schaffner/PD_GRS/grs_scaled_xlim_15Nov2025.png)
...
#                             Pseudo.R.squared
#McFadden                            0.0326534
#Cox and Snell (ML)                  0.0398888
#Nagelkerke (Cragg and Uhler)        0.0559825
...
summary(fit1_male) #GRS scaled: p = 0.0487
...
#                             Pseudo.R.squared
#McFadden                            0.0276617
#Cox and Snell (ML)                  0.0335784
#Nagelkerke (Cragg and Uhler)        0.0473542
...
summary(fit1_female) #GRS p = 0.0185 
...
#                             Pseudo.R.squared
#McFadden                            0.0476756
#Cox and Snell (ML)                  0.0578469
#Nagelkerke (Cragg and Uhler)        0.0810802
...
```{r plot GRS, eval=F}
r2_labels <- c(0.0560,0.0474,0.0811)
...
png("~/PD_GRS/prs_plots_by_PD_sex_15Nov2025.png", width=600, height=500)
ggboxplot(
  to_plot,
  x = "PD",
  y = "GRS_scaled",
...
png("~/PD_GRS/prs_plots_by_sex_15Nov2025.png", width=300, height=500)
ggboxplot(
  to_plot,
  x = "Sex",
  y = "GRS_scaled",
...
dev.off()
```
![GRS by PD status and sex](/home1/NEURO/schaffner/PD_GRS/prs_plots_by_PD_sex_15Nov2025.png)

![PRS by sex (cases and controls combined)](/home1/NEURO/schaffner/PD_GRS/prs_plots_by_sex_15Nov2025.png)
